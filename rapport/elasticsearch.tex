...
La directive \textbf{PUT} est utilisé pour renseigner de nouvelles informations dans Elasticsearch.\\[3mm]
...
Ce n'est pas un outils de recherche\footnote{Outils de recherche abordé dans la section suivante}.\\[3mm]
