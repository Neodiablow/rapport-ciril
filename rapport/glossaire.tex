...
\newglossaryentry{node}{name={node},
                             description={Node ou noeud. Dans la terminologie elasticsearch, un node est processus java 
}}

\newglossaryentry{shard}{name={shard},
                             description={Shard dans la terminologie elasticsearch, un shard est une instance de lucene. Il existe des shards primaires et des shards répliqués. 
}}
