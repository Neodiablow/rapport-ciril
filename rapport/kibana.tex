...
Kibana est à la fois un front-end à Elasticsearch permettant de présenter les données. 
...
iframes. On peut ainsi facilement les ajouter dans une page de monitoring par exemple.\\[3mm]

Voir l'image d'un Dashboard plus avancé p\pageref{fig:kibanatuto12}\\[2mm]
Partie non essentielle sur les \emph{settings} p\pageref{subsec:settings}
