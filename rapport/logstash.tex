...
Cet exemple de code n'est pas à utiliser dans la mesure ou c'est une boucle infinie.
...
Une bonne pratique consiste, à utiliser la convention de nommage suivante : \textit{00-description,
01-description} etc \ldots
...
Chacun de ces plugins possède sa propre son propre paramétrage,
réalisable au travers de directives, mais avec une syntaxe commune.
...
La plupart des directives se comportent ainsi, ce n'est pas le cas pour toutes, nous
