...
\subsection{La base}
Grossièrement Logstash permet de traiter et transférer des données, en masse. Nous
l'utiliserons essentiellement avec Elasticsearch en utilitaire de sorti. Cependant,
