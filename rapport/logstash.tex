...
Par défaut syslog utilise le port 514, ce port est inférieur à 1024, et donc \textit{privilégiés}.
...
cap\_net\_bind\_service permet à un utilisateur non privilégié (non root) d'écouter
sur les ports privilégiés.
